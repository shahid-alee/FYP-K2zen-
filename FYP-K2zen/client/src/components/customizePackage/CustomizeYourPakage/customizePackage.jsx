...
export default function CustomizePackage() {
  ...
  return (
    <Box className="customize-section">
      {/* 🌄 Header Section */}
      <div className="section-header">
        ...
        <Typography className="section-subtitle">
          Plan your dream adventure — select your destinations, accommodation,
        ...
        <CardContent>
          <form onSubmit={handleSubmit}>
            <Grid container spacing={3}>
                  ...
                  >
                    {placesOptions.map((place) => (
                      <MenuItem key={place} value={place}>
                        <Checkbox
                          checked={form.destinationPlaces.indexOf(place) > -1}
                        />
              ...
              <Grid item xs={12}>
                <Button type="submit" className="customize-btn">
                  Build My Package
                </Button>
              </Grid>
            </Grid>
